...
export default class Fetchdatamanager extends React.Component{
    ...
    render()
    {
        return(
            ...
            <Text style={{fontSize: 30, textAlign: "center", fontWeight: "bold", marginBottom: 10}}>
            {manager.FirstName} {manager.LastName}</Text>
            <Text style={{fontSize: 15}}>Email Address:{manager.email}</Text>
            <Text style={{fontSize: 15}}>Contact Number:{manager.phone}</Text>
            <Text style={{fontSize: 15}}>City:{manager.item2}</Text>
            <Text style={{fontSize: 15}}>Experience:{manager.item1}</Text>
            </View>


            <View style={styles.introbox}>
            <Text style={{textAlign:'center', color:"#f47100", fontWeight:'bold'}}>ABOUT ME</Text>
            ...
            <Image source={{ uri: 'https://eventmanagementpak.files.wordpress.com/2013/11/296252_147040328721269_147008648724437_246728_2308363_n.jpg' }}
             style={{ width: "95%", height: 200, marginTop: 20, marginBottom: 10, marginLeft: 8 }}/>
            <TouchableOpacity>
            <Feather name="phone-call" size={40} color="black" style={{marginLeft: 310}}/>
            </TouchableOpacity>
            </View>      
         )})}  
